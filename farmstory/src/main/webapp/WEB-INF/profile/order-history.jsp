    ...
    <div id="wrapper">
        <header>
            ...
            <span class="home">
                ...
                <a href="/farmstory/users/login.do">로그인</a>&thinsp;|&thinsp;
                <a href="/farmstory/users/singup.do">회원가입</a>&thinsp;|&thinsp;
                <a href="/farmstory/profile/cart.do">나의정보</a>&thinsp;|&thinsp;
                <a href="/farmstory/main/main.do">로그아웃</a>&thinsp;|&thinsp;
            ...
            <section class="main_btm">
                <aside>
                    ...
                    <div class="list">
                        ...
                        <a href="/farmstory//profile/order-history.do"><img src="/farmstory/images/myinfo/myinfo_menu2_ov.png" alt="주문내역"></a>
                        <a href="/farmstory//profile/update-info.do"><img src="/farmstory/images/myinfo/myinfo_menu3.png" alt="정보수정"></a>
                    </div>
                </aside>
                <article>
                    <nav>
