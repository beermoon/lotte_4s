...
<head>
  ...
  <style>
    ...
    main > .main_top {
        ...
        width: 100%;
        height: 184px;
        background-image: url("../images/myinfo/myinfo_top_bg.jpg");
    }
    ...
    main .list > a:nth-child(1) > img:hover {background-image:url("../images/sub_cate3_lnb1_ov.png");}
    main .list > a:nth-child(2) > img:hover {background-image:url("../images/sub_cate3_lnb2_ov.png");}
    main .list > a:nth-child(3) > img:hover {background-image:url("../images/sub_cate3_lnb3_ov.png");}
        ...
        <main>
            ...
            <section class="main_btm">
                <aside>
                    ...
                    <div class="list">
                        <a href="../profile/cart.html"><img src="/farmstory/images/sub_cate3_lnb1.png" alt="농작물이야기"></a>
                        <a href="../profile/order-history.html"><img src="/farmstory/images/sub_cate3_lnb2.png" alt="텃밭가꾸기"></a>
                        <a href="../profile/update-info.html"><img src="/farmstory/images/sub_cate3_lnb3.png" alt="귀농학교"></a>
                    </div>
                </aside>
                <article>
                    <nav>
